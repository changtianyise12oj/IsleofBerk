...
import com.GACMD.isleofberk.common.entity.entities.AI.flight.own.UntamedDragonCircleFlightGoal;
import com.GACMD.isleofberk.common.entity.entities.AI.flight.player.AIDragonLand;
import com.GACMD.isleofberk.common.entity.entities.AI.flight.player.AIDragonRide;
import com.GACMD.isleofberk.common.entity.entities.AI.flight.player.DragonCatchOwnerGoal;
import com.GACMD.isleofberk.common.entity.entities.AI.flight.player.DragonElytraFlyingWithOwnerGoal;
import com.GACMD.isleofberk.common.entity.entities.AI.path.air.DragonFlyingPathNavigation;
import com.GACMD.isleofberk.common.entity.entities.AI.path.air.FlyingDragonMoveControl;
import com.GACMD.isleofberk.common.entity.entities.AI.target.DragonNonTameRandomTargetGoal;
...
public class ADragonBaseFlyingRideable extends ADragonRideableUtility implements IAnimatable, PlayerRideable {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new DragonElytraFlyingWithOwnerGoal(this));
...
//            double y = calculateFlightHeight(xHeadRot);
                ...
                if (this.isGoingUp()) {
                    this.setDeltaMovement(this.getDeltaMovement().add(0, zza > 0 ? this.getAttributeValue(Attributes.FLYING_SPEED) : 0.4, 0));
                } else if (this.isGoingDown()) {
                    this.setDeltaMovement(this.getDeltaMovement().add(0, zza > 0 ? -this.getAttributeValue(Attributes.FLYING_SPEED) : -0.6, 0));
                }
