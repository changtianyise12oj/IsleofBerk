...
public class SpeedStingerLeader extends SpeedStinger {
    ...
    public void registerControllers(AnimationData data) {
        data.addAnimationController(new AnimationController<SpeedStingerLeader>(this, "speed_stinger_leader_controller", getTransitionTicks(), this::basicMovementController));
