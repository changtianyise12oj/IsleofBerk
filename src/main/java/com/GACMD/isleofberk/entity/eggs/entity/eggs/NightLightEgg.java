...
public class NightLightEgg extends ADragonMediumEggBase implements IAnimatable {
    public static final ResourceLocation TEXTURE = new ResourceLocation("isleofberk:textures/egg/night_light/egg_night_light.png");
    private final int hatchTime;

    public NightLightEgg(EntityType<? extends ADragonEggBase> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.hatchTime = ModConfigs.hatchTimeConfig.nightFury.get();
    }
    ...
    protected ADragonBase getDragonEggResult() {
        return ModEntities.NIGHT_LIGHT.get().create(this.level);
    }

    @Override
    protected DragonEggItem getItemVersion() {
        return ModItems.NIGHT_LIGHT_EGG.get();
    }
    ...
    {
        return new ItemStack(ModItems.NIGHT_LIGHT_EGG.get());
    }
}
