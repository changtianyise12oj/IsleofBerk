...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> NIGHT_FURY_BITE                  = registerSoundEvent("entity.night_fury.bite");
    ...
    public static final RegistryObject<SoundEvent> LIGHT_FURY_BITE                  = registerSoundEvent("entity.light_fury.bite");
    ...
    public static final RegistryObject<SoundEvent> HIDEOUS_ZIPPLEBACK_BITE          = registerSoundEvent("entity.zippleback.bite");
    ...
    public static final RegistryObject<SoundEvent> SPEED_STINGER_STING              = registerSoundEvent("entity.speed_stinger.sting");
    public static final RegistryObject<SoundEvent> SPEED_STINGER_BITE               = registerSoundEvent("entity.speed_stinger.bite");
    ...
    public static final RegistryObject<SoundEvent> STINGER_BITE                     = registerSoundEvent("entity.stinger.bite");
