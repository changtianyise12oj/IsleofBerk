...
public class FuryBoltParticle extends TextureSheetParticle {

    private final SpriteSet sprites;
    private final int rotation;
    private final boolean isFlipped;

    FuryBoltParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pQuadSizeMulitiplier, SpriteSet pSprites) {
    ...
    public float getQuadSize(float pScaleFactor) {
        ...
        return this.quadSize * (1F - f * f * 0.5F);
    }
    ...
    public static class FuryBoltParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType pType, ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed) {
            return new FireBoltParticle(pLevel, pX, pY, pZ, pXSpeed, this.spriteSet);
        }
    }
}
